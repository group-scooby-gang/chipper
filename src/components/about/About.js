        ...
        return (
            <div className="aboutCard">
                ...
                <div className="layout">
                    ...
                    <h2>Josef Walls</h2>
                    <h4>Assistant to the HR Manager & Manager, Front and Back End Developer, CRTASN (Cheif Rollercoaster Tester and Spongebob Negotiator)</h4>
                ...
                <div className="layout">
                    ...
                    <h2>Jesse Badgley</h2>
                    <h4>Design Director, Stylin' and Profilin', Front-End Developer, COCCT (Cheif Office Cat Care-Taker)</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Arcu risus quis varius quam quisque id diam vel. Mattis molestie a iaculis at erat pellentesque adipiscing. Facilisis volutpat est velit egestas dui id ornare arcu odio.</p>
                ...
                <div className="layout">
                    ...
                    <h2>Nathan Visser</h2>
                    <h4>Front-End Developer, External Tech Dev, DOHOS (Director of Heads of Sales)</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur ask adipiscing elit, sed do eiusmod tempor incididunt me ut labore et dolore magna aliqua. Arcu about risus quis varius quam quisque id diam the vel. Mattis molestie a iaculis at erat pellentesque adipiscing. Calendar facilisis volutpat est velit egestas control c dui id ornare arcu odio control v.</p>
                ...
                <div className="layout">
                    ...
                    <h2>Kyle Carter</h2>
                    <h4>Regional Project Manager, Font-End Developer, Lil-Bit-Back-End Developer, Lead talker, LDORCO (Lead Director of Regional Custodian Operations)</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Arcu risus quis varius quam quisque id diam vel. Mattis molestie a iaculis at erat pellentesque adipiscing. Facilisis volutpat est velit egestas dui id ornare arcu odio.</p>
                </div>
                </div>
        )
