...
class UserType extends Component {
  ...
  handleRegisterOwner = async (e) => {
    e.preventDefault();
    const { userName, firstName, lastName, email, profileImg, password, phone, address, apt, city, state, zip } = this.props;
  ...
  render() {
    return (
      <div>
        ...
        <input onChange={this.handleChange} type="text" placeholder="apt" name='apt' />
        <input onChange={this.handleChange} type="text" placeholder="city" name='city' />
        <input onChange={this.handleChange} type="text" placeholder="state" name='state' />
        <input onChange={this.handleChange} type="text" placeholder="zip" name='zip' />
        <div className="button_section">
          <button onClick={this.handleRegisterOwner}>I am a dog owner</button>
          <button onClick={this.handleRegisterWalker}>I am a dog walker</button>
        </div>
        {
